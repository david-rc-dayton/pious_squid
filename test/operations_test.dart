...
void main() {
  ...
  test('Vector3D', () {
    ...
    expect(outer[0][0], equals(4));
    expect(outer[0][1], equals(5));
    expect(outer[0][2], equals(6));
    expect(outer[1][0], equals(8));
    expect(outer[1][1], equals(10));
    expect(outer[1][2], equals(12));
    expect(outer[2][0], equals(12));
    expect(outer[2][1], equals(15));
    expect(outer[2][2], equals(18));
  });
  ...
  test('Vector', () {
    ...
    expect(outer[0][1], equals(5));
    expect(outer[0][2], equals(6));
    expect(outer[0][3], equals(7));
    expect(outer[1][0], equals(8));
    expect(outer[1][1], equals(10));
    expect(outer[1][2], equals(12));
    expect(outer[1][3], equals(14));
    expect(outer[2][0], equals(12));
    expect(outer[2][1], equals(15));
    expect(outer[2][2], equals(18));
    expect(outer[2][3], equals(21));
  });
}
